...
pub(crate) async fn _subscribe_pending_txs(provider: Arc<Provider<Ws>>, tx: Sender<EventType>) {
...
pub(crate) async fn _subscribe_blocks(provider: Arc<Provider<Ws>>, tx: Sender<EventType>) {
...
pub(crate) async fn _subscribe_logs(provider: Arc<Provider<Ws>>, tx: Sender<EventType>, filter: Filter) {
